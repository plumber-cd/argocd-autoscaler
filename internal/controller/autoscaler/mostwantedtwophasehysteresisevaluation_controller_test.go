...
var _ = Describe("MostWantedTwoPhaseHysteresisEvaluation Controller", func() {
	Context("When reconciling a resource", func() {
		...
		mostwantedtwophasehysteresisevaluation := &autoscalerv1alpha1.MostWantedTwoPhaseHysteresisEvaluation{}
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance MostWantedTwoPhaseHysteresisEvaluation")
