...
var _ = Describe("LongestProcessingTimePartition Controller", func() {
	Context("When reconciling a resource", func() {
		...
		longestprocessingtimepartition := &autoscalerv1alpha1.LongestProcessingTimePartition{}
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance LongestProcessingTimePartition")
