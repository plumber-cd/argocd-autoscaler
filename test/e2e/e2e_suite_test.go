...
var (
	...
	projectImage = "ghcr.io/plumber-cd/argocd-autoscaler:v0.0.0"
)
...
func TestE2E(t *testing.T) {
	...
	_, _ = fmt.Fprintf(GinkgoWriter, "Starting argocd-autoscaler integration test suite\n")
	...
	if !skipPrometheusInstall {
		...
		if !isPrometheusOperatorAlreadyInstalled {
			...
			Eventually(func(g Gomega) {
				g.Expect(utils.InstallPrometheusOperator()).To(Succeed(), "Failed to install Prometheus Operator")
			}, "20s").Should(Succeed())
		} else {
