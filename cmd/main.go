...
func main() {
	...
	flag.StringVar(&namespacesArg, "namespaces", "", "List of namespaces to watch"+
	...
	namespaces := strings.Split(namespacesArg, ",")
	...
	options := ctrl.Options{
		...
		LeaderElectionID:              "c172113e.argocd-autoscaler.argoproj.io",
	...
	if err = (&autoscalercontroller.SecretTypeClusterShardManagerReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "SecretTypeClusterShardManager")
		os.Exit(1)
	}
	...
	if err = (&autoscalercontroller.MostWantedTwoPhaseHysteresisEvaluationReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
	...
	if err = (&autoscalercontroller.ReplicaSetScalerReconciler{
		...
		Recorder:  mgr.GetEventRecorder("argocd-autoscaler"),
	}).SetupWithManager(mgr); err != nil {
