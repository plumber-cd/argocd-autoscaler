...
func (in *LongestProcessingTimePartitionSpec) DeepCopyInto(out *LongestProcessingTimePartitionSpec) {
	*out = *in
	...
	if in.MaxShardsPerReplica != nil {
		in, out := &in.MaxShardsPerReplica, &out.MaxShardsPerReplica
		*out = new(int32)
		**out = **in
	}
}
...
func (in *MostWantedTwoPhaseHysteresisEvaluationSpec) DeepCopyInto(out *MostWantedTwoPhaseHysteresisEvaluationSpec) {
	*out = *in
	...
	if in.ScaleUpStabilizationPeriod != nil {
		in, out := &in.ScaleUpStabilizationPeriod, &out.ScaleUpStabilizationPeriod
		*out = new(v1.Duration)
		**out = **in
	}
	if in.ScaleDownStabilizationPeriod != nil {
		in, out := &in.ScaleDownStabilizationPeriod, &out.ScaleDownStabilizationPeriod
		*out = new(v1.Duration)
		**out = **in
	}
}
...
func (in *RobustScalingNormalizerSpec) DeepCopyInto(out *RobustScalingNormalizerSpec) {
	*out = *in
	...
	if in.PositiveOffsetE != nil {
		in, out := &in.PositiveOffsetE, &out.PositiveOffsetE
		x := (*in).DeepCopy()
		*out = &x
	}
}
